...
function Home() {
  ...
  // Debounce (500ms), on attend que l'utilisateur n'ait pas tapé pendant 500
  // useEffect(function () {
  ...
  //     });
  //   // on vérifie les deux condiations : le texte est inclus dans la titre du film, le genre aussi
